module.exports = {
    ...
    master: {
        ...
        // Local box config
        box: {
            password:    'IGZY5R3wVNJdMmKNr5[XLQ4Bd%z2', // Box server password
        ...
        reception: {
            password:    'biS$MTARyQNATIp0$LRyT((2c[)Qo2z999', // Reception server password
            listen_ip:   '0.0.0.0', // IP of interface to listen
        ...
        // Wapi server config
        wapi: {
            password:    'W]sZ!V(NIlR{AXJ2QAcZxJ1eaU9d5MOq2iIEPAFG8zyk', // Wapi server password
            listen_ip:   '0.0.0.0', // IP of interface to listen
    ...
    dapi: {
        password:    'dapisecure<3@', // Dapi client password
    ...
    box: {
       version: 1, //versions to accept
        ...
        socks_per_bot:          1.5,      //amount of SOCKS to request for bots
        ...
        customer_dataproxy_port_min: 10000, //min port to open for accept data from user
        customer_dataproxy_port_max: 60000, //max port to open for accept data from user
        ...
        coordinator_socks_count:      0/*3*/,     //how much SOCKS take from `party_check_threads` to run coordinators
