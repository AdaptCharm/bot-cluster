...
Bot.prototype.processors = {
    ...
    '32': function(packet) {
        //todo if new nickname != known nickname > this is new spawned bot
    ...
    '64': function(packet) {
        ...
        if((max_x-min_x) < 7000 || (max_y-min_y) < 7000) return;

        var random_x = Math.round(Math.random() * 50) - 25;
        var random_y = Math.round(Math.random() * 50) - 25;

        this.offset_x = min_x + random_x;
        this.offset_y = min_y + random_y;
    }
